try {
    ...
    # Ensure your CSV file has the headers: Name,Hostname,Protocol,Container,Description
    ...
    function Create-Container($parentNode, $containerPath) {
    ...
    foreach ($entry in $Content) {
        ...
        $Container = Create-Container -parentNode $RootNode -containerPath $entry.Container
        ...
        $Connection.SetAttribute("PuttySession", "Cisco-SSH")
